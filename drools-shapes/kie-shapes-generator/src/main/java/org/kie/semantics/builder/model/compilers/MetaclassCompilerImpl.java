...
import org.kie.semantics.builder.model.AbstractJavaModelImpl;
...
public class MetaclassCompilerImpl extends ModelCompilerImpl implements MetaclassModelCompiler {
    ...
    public void compile( Concept con, Object tgt, Map<String, Object> params ) {
	    ...
	    String metaClassTempl = "metaClass";
    ...
    private boolean isLocal( PropertyRelation prop, Concept con ) {
	    return prop.isPublic() &&
			    ( con.getChosenProperties().containsValue( prop )
					    || prop.getDomain().isAnonymous()
					    || !con.getChosenSuperConcept().hasImplProperty( prop ) );
    }
    ...
    private Concept findConcreteParent( Concept base,
                                        Concept chosenSuperConcept,
                                        Set<PropInfo> localProperties,
                                        Map<String, PropInfo> properties ) {
        while ( chosenSuperConcept.isAbstrakt() || chosenSuperConcept.isAnonymous() ) {
            if ( chosenSuperConcept == chosenSuperConcept.getChosenSuperConcept() ) {
                return model.getConcept( Thing.IRI );
            }
    ...
    public String buildFactory( String pack ) {
	    ...
	    String metaFactoryTempl = "metaFactory";
    ...
    public static class PropInfo {
        ...
        public boolean equals( Object o ) {
	        ...
	        return from.equals( propInfo.from );
        }
