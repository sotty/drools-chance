...
public class PropertyRelation extends Relation implements Cloneable {
    ...
    private List<PropertyRelation> restrictedProperties = new ArrayList<>();

    private Set<List<PropertyRelation>> chains = new HashSet<>();
    ...
    public PropertyRelation clone() {
        ...
        rel.restrictedProperties = new ArrayList<>( this.restrictedProperties );
        rel.chains = new HashSet<>( this.chains );
    ...
    public boolean mirrors( PropertyRelation that ) {
        ...
        if (name != null ? !name.equals(that.name) : that.name != null)  {
        	return false;
        } else if (object != null ? !object.equals(that.object) : that.object != null) {
	        return false;
        } else if (property != null ? !property.equals(that.property) : that.property != null) {
        	return false;
        } else if (minCard != null ? !minCard.equals(that.minCard) : that.minCard != null) {
        	return false;
        } else {
	        if ( maxCard != null ? !maxCard.equals( that.maxCard ) : that.maxCard != null ) {
	        	return false;
	        }
        }
        return true;
    ...
    public boolean equals(Object o) {
        ...
        if (name != null ? !name.equals(that.name) : that.name != null) {
        	...
        	return false;
        } else if (subject != null ? !subject.equals(that.subject) : that.subject != null) {
        	return false;
        }
