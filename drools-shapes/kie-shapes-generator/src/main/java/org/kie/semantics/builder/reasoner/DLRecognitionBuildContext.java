...
public class DLRecognitionBuildContext {
    ...
    private Stack<BuildStep> vars = new Stack<>();
    ...
    public static class BuildStep {
        private String var;
        private Map<String,PatternDescrBuilder<? extends CEDescrBuilder<? extends CEDescrBuilder, ? extends AnnotatedBaseDescr>>> patterns = new HashMap<>();
        private Map<String,String> propertyVars = new HashMap<>();
