...
public class ObjectDescriptor {
    ...
    public enum NODETYPE { ROOT, DATA, OBJECT }

    private Object object;
    private NODETYPE type;
    private String label;

    private List<RelationDescriptor> outRelations = new ArrayList<>();
    private List<RelationDescriptor> inRelations = new ArrayList<>();

    private Map<String, RelationDescriptor> relations = new HashMap<>();
