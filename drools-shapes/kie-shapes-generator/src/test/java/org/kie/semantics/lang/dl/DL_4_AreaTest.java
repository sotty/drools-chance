...
public class DL_4_AreaTest {
    ...
    public void testArea1() {
        try {
            ...
            Set<PropertyRelation> s0 = Collections.emptySet();
            Set<PropertyRelation> s1 = new HashSet<>( Collections.singletonList( drug ) );
            Set<PropertyRelation> s2 = new HashSet<>( Collections.singletonList( fluid ) );
            Set<PropertyRelation> s3 = new HashSet<>( Collections.singletonList( bsub ) );
            ...
            // Now check roots
            assertEquals( n1.getRoots(), new HashSet<>( Collections.singletonList( c02 ) ) );
            assertEquals( n2.getRoots(), new HashSet<>( Collections.singletonList( c01 ) ) );
            assertEquals( n3.getRoots(), new HashSet<>( Collections.singletonList( c04 ) ) );
            assertEquals( n4.getRoots(), new HashSet<>( Collections.singletonList( c03 ) ) );
            assertEquals( n5.getRoots(), new HashSet<>( Arrays.asList( c05, c14 ) ) );
            assertEquals( n7.getRoots(), new HashSet<>( Arrays.asList( c06, c09 ) ) );
