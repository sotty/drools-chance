...
//            }
    ...
    public void testJarModelGeneration() {
        ...
        try {
            ClassLoader cl = new ItemClassLoader( jarModel.getCompiledTraits(), Thread.currentThread().getContextClassLoader() );
    ...
    private class ItemClassLoader extends ClassLoader {
        ...
        public ItemClassLoader( Map<String, JarModel.Holder> itemClasses, ClassLoader parent ) {
            super( parent );
...
//        xsdModel.streamBindings( System.out );
        ...
        try {
            ...
            fos.write( xsdModel.getSerializedBindings().getBytes() );
            fos.flush();
            fos.close();
        } catch (Exception e) {
            e.printStackTrace();
...
//        String source = "rules.owl";
        ...
        System.out.println( xsdModel.getIndividualFactory() );
...
//        String source = "rules.owl";
    ...
    private boolean checkProperty( Concept base, String pack, String propName, String target, Integer minCard, Integer maxCard, boolean restricted, boolean inherited ) {
	    ...
	    return rel != null
			    && rel.getTarget().getName().equals( target )
			    && Objects.equals(rel.getMinCard(), minCard )
			    && Objects.equals( rel.getMaxCard(),  maxCard )
    ...
    public void testNestedClassesByDisjunction() {
        ...
        assertNotNull( subKlass );
        assertNotNull( yetKlass );
        ...
        assertNotNull( randKlass );
        assertNotNull( caslKlass );
    ...
    public void testAnonymousClassIndividual() {
        ...
        Concept joeRestriction = results.getConcept( "<http://owl.man.ac.uk/2005/07/sssw/people#JoeRestrictedType2>" );
    ...
    private void checkConceptEncoding( OntoModel results ) {
        boolean ans = true;
        for ( Concept con : results.getConcepts() ) {
