 ...
 */
public class CTS2TermsProviderImpl implements TermsInferenceService {

    public static final String KIND = "cts2";

    private ServiceProvider serviceProvider;

    public CTS2TermsProviderImpl() {
        this( null );
    }

    public CTS2TermsProviderImpl( ServiceProvider serviceProvider ) {
        super();
