...
public class ComplexElementsTest {
    ...
    public static void parse() {
        ...
        URL url = converter.getSchemaURL( "org/kie/shapes/xsd/complexElements.xsd" );
    ...
    public void testObjectProperties() {
        ...
        try {
            ...
            assertEquals( 2, onto.subClassAxiomsForSubClass( k ).count() );
            assertEquals( 2, onto.subClassAxiomsForSubClass( x ).count() );
            ...
            assertTrue( onto.containsAxiom( factory.getOWLDataPropertyRangeAxiom( p2, OWL2Datatype.XSD_STRING ) ) );
            assertTrue( onto.containsAxiom( factory.getOWLDataPropertyRangeAxiom( p3, OWL2Datatype.XSD_STRING ) ) );
