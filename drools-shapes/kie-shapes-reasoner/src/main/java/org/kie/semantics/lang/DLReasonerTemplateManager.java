...
package org.kie.semantics.lang;
...
public class DLReasonerTemplateManager {
    ...
    public static final String BASE_PACK = "org.kie.semantics.builder";
    ...
    public static Optional<TemplateRegistry> getTableauRegistry( DLFamilies target ) {
        switch ( target ) {
	        case FALC :
        	    return Optional.of( tableauRegistry );
	        default:
