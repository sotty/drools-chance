...
public class TopElementsTest {
    ...
    public static void parse() {
        ...
        URL url = converter.getSchemaURL( "org/kie/shapes/xsd/topElements.xsd" );
    ...
    public void testTopElementGroups() {
        ...
        try {
            ...
            OWLDatatype string = factory.getOWLDatatype( OWL2Datatype.XSD_STRING );
            OWLDatatype floot = factory.getOWLDatatype( OWL2Datatype.XSD_FLOAT );
            OWLDatatype intx = factory.getOWLDatatype( OWL2Datatype.XSD_INT );
