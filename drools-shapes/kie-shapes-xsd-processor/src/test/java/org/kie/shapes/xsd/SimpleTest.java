...
public class SimpleTest {
    ...
    public void testSimpleType() {
        ...
        try {
            ...
            URL url = converter.getSchemaURL( "org/kie/shapes/xsd/simple.xsd" );
        ...
        try {
            ...
            assertTrue( onto.containsAxiom(
                    factory.getOWLDatatypeDefinitionAxiom(
                            ...
                            factory.getOWLDatatypeRestriction(
                                    factory.getOWLDatatype( OWL2Datatype.XSD_STRING ),
                                    OWLFacet.LENGTH,
                                    factory.getOWLLiteral( "2", OWL2Datatype.XSD_INT ) )
                    )
            ));
            assertTrue( onto.containsAxiom(
                    factory.getOWLDatatypeDefinitionAxiom(
                            ...
                            factory.getOWLDatatypeRestriction(
		                            factory.getOWLDatatype( OWL2Datatype.XSD_STRING ),
                                    OWLFacet.MAX_LENGTH,
                                    factory.getOWLLiteral( "6", OWL2Datatype.XSD_INT ) )
                    )
            ));
            assertTrue( onto.containsAxiom(
                    factory.getOWLDatatypeDefinitionAxiom(
            ...
            assertTrue( onto.containsAxiom(
                    factory.getOWLDatatypeDefinitionAxiom(
                            ...
                            factory.getOWLDatatypeRestriction(
                                    factory.getOWLDatatype( OWL2Datatype.XSD_DOUBLE ),
                                    OWLFacet.MIN_INCLUSIVE,
                                    factory.getOWLLiteral( "11.0", OWL2Datatype.XSD_DOUBLE ) )
                    )
            ));
            assertTrue( onto.containsAxiom(
                    factory.getOWLDatatypeDefinitionAxiom(
                            ...
                            factory.getOWLDatatypeRestriction(
                                    ...
                                    factory.getOWLLiteral( "13.0", OWL2Datatype.XSD_DOUBLE ) )
                    )
            ));
            ...
            assertTrue( onto.containsAxiom(
                    factory.getOWLDatatypeDefinitionAxiom(
                            ...
                            factory.getOWLDataUnionOf(
                                    factory.getOWLDatatype( OWL2Datatype.XSD_ANY_URI ),
                                    factory.getOWLDatatype( OWL2Datatype.XSD_DECIMAL ),
                                    factory.getOWLDatatype( OWL2Datatype.XSD_DATE_TIME )
                            )
                    ) )
            );


            assertEquals( 4, onto.subClassAxiomsForSubClass( ts ).count() );
    ...
    public void testSimpleList() {
        ...
        try {
            ...
            URL url = converter.getSchemaURL( "org/kie/shapes/xsd/simpleList.xsd" );
            Schema x = converter.parse( url );
            String tns = x.getTargetNamespace() + "#";
            ...
            assertTrue( onto.containsAxiom(
                    factory.getOWLDatatypeDefinitionAxiom(
                            ...
                            factory.getOWLDatatypeRestriction(
                                    factory.getOWLDatatype( OWL2Datatype.XSD_INT ),
                                    OWLFacet.MIN_INCLUSIVE,
                                    factory.getOWLLiteral( "1", OWL2Datatype.XSD_INT ) )
                    )
            ));
            assertTrue( onto.containsAxiom(
                    factory.getOWLDatatypeDefinitionAxiom(
            ...
            assertTrue( onto.containsAxiom(
                    factory.getOWLDatatypeDefinitionAxiom(
                            ...
                            factory.getOWLDatatypeRestriction(
                                    factory.getOWLDatatype( OWL2Datatype.XSD_INT ),
                                    OWLFacet.MAX_INCLUSIVE,
                                    factory.getOWLLiteral( "8", OWL2Datatype.XSD_INT ) )
                    )
            ));
            ...
            assertTrue( onto.containsAxiom(
                    factory.getOWLDatatypeDefinitionAxiom(
                            ...
                            factory.getOWLDatatypeRestriction(
                                    factory.getOWLDatatype( OWL2Datatype.XSD_INT ),
                                    OWLFacet.MAX_INCLUSIVE,
                                    factory.getOWLLiteral( "20", ( OWL2Datatype.XSD_INT ) ) )
                    )
            ));
