...
public class AttrGroupTest {
    ...
    public void testAttGroup() {
        ...
        try {
            ...
            URL url = converter.getSchemaURL( "org/kie/shapes/xsd/attrGroup.xsd" );
            ...
            OWL2Datatype bool = OWL2Datatype.XSD_BOOLEAN;
            ...
            assertEquals( 6 + 1, onto.subClassAxiomsForSubClass( ivl ).count() );
            assertEquals( 2 + 1, onto.subClassAxiomsForSubClass( xyz ).count() );
