...
public class KeyPlugin extends Plugin {
    ...
    private static final String equalsTempl = "equals";
    private static final String hashKyTempl = "hashKy";
    ...
    public boolean run(Outline outline, Options opt, ErrorHandler errorHandler) throws SAXException {
        for (ClassOutline co : outline.getClasses() ) {
            ...
            CPluginCustomization c = co.target.getCustomizations().find( uri, "keyId" );
            CPluginCustomization d = co.target.getCustomizations().find( metaURI, "type" );
            if( c == null ) {
                continue;
            }
    ...
    public static class Key {
        ...
        public boolean equals(Object o) {
	        ...
	        return ( name != null ? name.equals( key.name ) : key.name == null ) && ( type != null ? type.equals( key.type ) : key.type == null );
        }
